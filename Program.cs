...
namespace Operations
{
    public class Program
    {
        ...
        public static async Task MeasureOperation<T>(Func<IOperation<T>> operationFactory)
        {
            ...
            var valueDisplay = result.HasValue ? result.Value.ToString() : "<NoValue>";
        ...
        {
            var result = value;
            // Console.WriteLine($"{nameof(Sqrt)} gets called: {result}");
            return result;
        }
